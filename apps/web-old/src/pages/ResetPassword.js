...
export default function ResetPassword() {
    ...
    return (_jsx("div", { className: "flex flex-col items-center justify-center min-h-screen bg-gradient-to-b from-blue-100 to-purple-100", children: _jsxs("div", { className: "bg-white p-6 rounded-xl shadow-md w-80", children: [stage === "request" && (_jsxs(_Fragment, { children: [_jsx("h1", { className: "text-xl font-semibold mb-4 text-center text-gray-800", children: "Reset your password" }), _jsxs("form", { onSubmit: handleSendReset, className: "flex flex-col gap-3", children: [_jsx("input", { type: "email", placeholder: "Your account email", value: email, onChange: (e) => setEmail(e.target.value), required: true, className: "border border-gray-300 px-3 py-2 rounded text-sm" }), _jsx("button", { type: "submit", className: "bg-blue-500 text-white py-2 rounded hover:bg-blue-600 transition", children: "Send reset email" })] })] })), stage === "update" && (_jsxs(_Fragment, { children: [_jsx("h1", { className: "text-xl font-semibold mb-4 text-center text-gray-800", children: "Enter a new password" }), _jsxs("form", { onSubmit: handleUpdatePassword, className: "flex flex-col gap-3", children: [_jsx("input", { type: "password", placeholder: "New password", value: password, onChange: (e) => setPassword(e.target.value), required: true, className: "border border-gray-300 px-3 py-2 rounded text-sm" }), _jsx("button", { type: "submit", className: "bg-green-500 text-white py-2 rounded hover:bg-green-600 transition", children: "Update Password" })] })] })), message && _jsx("p", { className: "text-green-600 text-sm mt-3 text-center", children: message }), error && _jsx("p", { className: "text-red-600 text-sm mt-3 text-center", children: error }), _jsx("button", { onClick: () => navigate("/login"), className: "text-sm text-gray-600 mt-4 underline w-full", children: "\u2190 Back to Login" })] }) }));
}
